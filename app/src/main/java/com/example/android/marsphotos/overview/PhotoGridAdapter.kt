...
//        // add the return for function class ViewHolder & inflate item Xml
...
object DiffCallback : DiffUtil.ItemCallback<MarsPhoto>(){
    override fun areItemsTheSame(oldItem: MarsPhoto, newItem: MarsPhoto): Boolean {
            ...
            // the return to compare between items by ID (dataClass)
                return oldItem.id == newItem.id
    }

    override fun areContentsTheSame(oldItem: MarsPhoto, newItem: MarsPhoto): Boolean {
            // the return to compare between items by images (dataClass)
